...
/* Required settings     */
$HCSET['OFFER_PAGE'] = 'https://logibuy.com/xxStJp';//PHP/HTML file or URL offer used for real users
...
$HCSET['FILTER_GEO_LIST'] = 'us,gb,ca,de,be, ar, fr, es'; // string([2Chars country codes])
...
/* NETWORK FILTERS */
$HCSET['FILTER_NET_MODE'] = 'allow'; // 'allow|reject'
$HCSET['FILTER_NET_LIST'] = 'vpn,mobile,residential,corporate'; // string([vpn|mobile|residential|corporate]);
...
$HCSET['API_SECRET_KEY'] = 'v14ca20daa5f944edb886d4ec5bd916e74';
/*********************************************/
...
function apiRequest($ip, $port, $HCSET, $HCSETdata)
{
    ...
    $url = 'http://'.$host.'/basic?ip=' . $ip . '&port=' . $port . '&key=' . $HCSET['API_SECRET_KEY'] . '&sign=v21334577647&js=false&stage='.$HCSET['stage'];
